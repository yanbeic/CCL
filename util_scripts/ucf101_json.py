...
def convert_ucf101_csv_to_json(label_csv_path, train_csv_path, val_csv_path,
                               video_dir_path, audio_dir_path, dst_json_path, video_type):
    ...
    if audio_dir_path is not None: # save the subset
        dst_json_path = dst_json_path.parent / dst_json_path.name.replace('ucf101', 'ucf51')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--audio_path',
                        default=None,
                        type=Path,
                        help=('Path of audio directory (npy).'))
    ...
    convert_ucf101_csv_to_json(label_csv_path, train_csv_path, val_csv_path,
                               args.video_path, args.audio_path, dst_json_path, args.video_type)
